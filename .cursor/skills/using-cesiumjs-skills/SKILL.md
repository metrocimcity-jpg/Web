...
When a question spans multiple domains, consult [DOMAINS.md](DOMAINS.md) — the definitive ownership map assigning every public CesiumJS class, function, and enum to exactly one skill. The catalog is in [skills-catalog.md](skills-catalog.md).
